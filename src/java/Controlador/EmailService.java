...
public class EmailService {
    ...
    // Si existe la variable de entorno BREVO_API_KEY se usa esa; si no, cae a
    // este valor fijo para que funcione sin configurar nada en el servidor.
    private static final String API_KEY = valorEnv("BREVO_API_KEY");

    private static final String EMAIL_FROM = "fitmanagercol@gmail.com";
    private static final String NOMBRE_REMITENTE = "FitManager";
    ...
    private static String valorEnv(String clave, String defecto) {
