...
@WebServlet(name = "RegistroEntrenamientoServlet", urlPatterns = {"/RegistroEntrenamientoServlet"})
public class RegistroEntrenamientoServlet extends HttpServlet {
    ...
    String registrosJson(List<Registros> registros) {
