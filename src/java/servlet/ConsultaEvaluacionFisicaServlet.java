...
@WebServlet("/ConsultaEvaluacionFisicaServlet")
public class ConsultaEvaluacionFisicaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        escribirJson(response, consultarJson(idUsuario));
    }

    /**
     * Logica compartida con MobileApiServlet: dado un idUsuario, devuelve el
     * arreglo JSON de evaluaciones fisicas (mismo formato para web y movil).
     */
    String consultarJson(int idUsuario) {
        if (idUsuario <= 0) {
            return "[]";
        }
