...
public class VerificacionServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/Vista/Verificacion.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (resultado == UsuariosDAO.ResultadoVerificacion.OK) {
            ...
            response.sendRedirect(request.getContextPath() + "/Vista/Login.jsp?registrado=true" + infoCompra);
        } else {
            String mensaje;
            switch (resultado) {
