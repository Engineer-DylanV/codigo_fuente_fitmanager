...
<html lang="es">
    ...
    <body class="login-body">
        ...
        <button id="btnVolver" class="btn-volver-icon" aria-label="Volver" onclick="window.location.href = '<c:url value='/Vista/Login.jsp' />'">
        </button>
        ...
        <div class="container-login container">
            ...
            <p class="mt-3"><a href="<c:url value='/Vista/Login.jsp' />">Volver a inicio de sesión</a></p>
        </div>
