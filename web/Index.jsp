    ...
    <body class="index-page" id="inicio">
        ...
        <header class="navbar">
            ...
            <div class="nav-catalogo">
                ...
                <a href="#descargar-app" class="btn-nav"><i class="fa-solid fa-mobile-screen-button"></i> App</a>
            </div>

            <div class="nav-buttons">
                <a href="<c:url value='/Vista/Login.jsp' />" class="btn-nav"><i class="fa-solid fa-user"></i> Iniciar sesión</a>
        ...
        <section class="hero">
            <div class="hero-content">
                ...
                <div class="hero-buttons">
                    ...
                    <a href="<c:url value='/Vista/Login.jsp' />" class="btn-main">Ya tengo cuenta</a>
                </div>
                            ...
                            <c:forEach var="p" items="${productos}">
                                ...
                                <div class="catalogo-card">
                                    ...
                                    <div class="catalogo-actions">
                                        <c:url var="comprarProductoUrl" value="/Vista/Login.jsp">
        ...
        <!-- DESCARGAR APP -->
        <c:url value="/descargas/FitManager.apk" var="apkPath" />
        <c:set var="apkUrl" value="${pageContext.request.scheme}://${header.host}${apkPath}" />
        <c:url value="https://api.qrserver.com/v1/create-qr-code/" var="qrUrl">
            <c:param name="size" value="220x220" />
            <c:param name="data" value="${apkUrl}" />
        </c:url>

        <section id="descargar-app" class="catalogo-panel" style="text-align:center;">
            <div class="catalogo-bull-bg" aria-hidden="true"></div>
            <a href="#inicio" class="btn-volver-icon" aria-label="Volver al inicio"></a>
            <div class="catalogo-header" style="justify-content:center;">
                <h2>Descarga la App</h2>
            </div>
            <p style="margin:0 auto 24px;max-width:520px;color:var(--text-muted,#6b7280);">
                Escanea el código QR con la cámara de tu celular para descargar la app
                de Fitmanager (Taurus GYM) (Android), o descárgala directamente desde este botón.
            </p>
            <div style="display:flex;flex-wrap:wrap;justify-content:center;align-items:center;gap:28px;">
                <img src="${qrUrl}" alt="Código QR para descargar la app" width="220" height="220"
                     style="border-radius:12px;border:1px solid #e5e7eb;background:#fff;padding:10px;">
                <div style="display:flex;flex-direction:column;gap:12px;align-items:center;">
                    <a href="${apkPath}" download class="btn-nav" style="padding:12px 22px;font-size:15px;">
                        Descargar APK
                    </a>
                    <span style="font-size:12px;color:var(--text-muted,#9ca3af);">Solo disponible para Android</span>
                </div>
            </div>
        </section>
